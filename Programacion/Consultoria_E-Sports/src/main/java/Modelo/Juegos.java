...
public class Juegos {
    ...
    private Collection<Competiciones> competicionesByCodJuego;
    ...
    public Collection<Competiciones> getCompeticionesByCodJuego() {
        return competicionesByCodJuego;
    }

    public void setCompeticionesByCodJuego(Collection<Competiciones> competicionesByCodJuego) {
        this.competicionesByCodJuego = competicionesByCodJuego;
    }
}
