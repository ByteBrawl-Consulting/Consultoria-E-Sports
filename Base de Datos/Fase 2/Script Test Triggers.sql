...
INSERT INTO COMPETICIONES 
(NOMBRE, FECHA_INICIO, FECHA_FIN, CURSO, EQUIPO_GANADOR, COD_JUEGO)
VALUES ('Competición Futura', TO_DATE('2024-06-01', 'YYYY-MM-DD'), TO_DATE('2024-06-02', 'YYYY-MM-DD'), 0, NULL, 1);

SELECT * FROM COMPETICIONES WHERE NOMBRE = 'Competición Futura';

INSERT INTO COMPETICIONES 
(NOMBRE, FECHA_INICIO, FECHA_FIN, CURSO, EQUIPO_GANADOR, COD_JUEGO)
VALUES ('Competición Pasada', TO_DATE('2024-04-30', 'YYYY-MM-DD'), TO_DATE('2024-05-01', 'YYYY-MM-DD'), 0, NULL, 1);
