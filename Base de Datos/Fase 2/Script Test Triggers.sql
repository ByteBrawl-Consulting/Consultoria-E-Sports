...
/*DELETE FROM EQUIPO_COMPETICION WHERE COD_EQUIPO = (SELECT COD_EQUIPO 
                                                   FROM EQUIPOS 
                                    WHERE UPPER(NOMBRE) = 'TEAM TEST 41 TRIG');
DELETE FROM JUGADORES WHERE UPPER(NOMBRE_JUGADOR) = 'Zapa Test';
DELETE FROM EQUIPOS WHERE UPPER(NOMBRE) = 'TEAM TEST 41 TRIG';
DELETE FROM COMPETICIONES WHERE UPPER(NOMBRE) = 'TEST TEAM PAR TRIG C5';
DELETE FROM JUEGOS WHERE UPPER(NOMBRE) = 'TEST TEAM PAR TRIG JUEGO 2'; */
