...
VALUES 
((SELECT COD_EQUIPO FROM EQUIPOS WHERE UPPER(NOMBRE) = 'TEAM ALPHA'), 
(SELECT COD_COMPE FROM COMPETICIONES WHERE UPPER (NOMBRE)='TORNEO 1'), 7);
INSERT INTO EQUIPO_COMPETICION (COD_EQUIPO, COD_COMPETICION, PUNTOS) 
VALUES ((SELECT COD_EQUIPO FROM EQUIPOS WHERE UPPER(NOMBRE) = 'TEAM BRAVO'), 
(SELECT COD_COMPE FROM COMPETICIONES WHERE UPPER (NOMBRE)='TORNEO 1'), 1);
INSERT INTO EQUIPO_COMPETICION (COD_EQUIPO, COD_COMPETICION, PUNTOS) 
VALUES ((SELECT COD_EQUIPO FROM EQUIPOS WHERE UPPER(NOMBRE) = 'TEAM CHARLIE'), 
(SELECT COD_COMPE FROM COMPETICIONES WHERE UPPER (NOMBRE)='TORNEO 1'), 20);
INSERT INTO EQUIPO_COMPETICION (COD_EQUIPO, COD_COMPETICION, PUNTOS) 
VALUES ((SELECT COD_EQUIPO FROM EQUIPOS WHERE UPPER(NOMBRE) = 'TEAM DELTA'), 
(SELECT COD_COMPE FROM COMPETICIONES WHERE UPPER (NOMBRE)='TORNEO 1'), 4);
INSERT INTO EQUIPO_COMPETICION (COD_EQUIPO, COD_COMPETICION, PUNTOS) 
VALUES ((SELECT COD_EQUIPO FROM EQUIPOS WHERE UPPER(NOMBRE) = 'TEAM ECHO'), 
(SELECT COD_COMPE FROM COMPETICIONES WHERE UPPER (NOMBRE)='TORNEO 2'), 2);
INSERT INTO EQUIPO_COMPETICION (COD_EQUIPO, COD_COMPETICION, PUNTOS) 
VALUES ((SELECT COD_EQUIPO FROM EQUIPOS WHERE UPPER(NOMBRE) = 'TEAM FOXTROT'), 
(SELECT COD_COMPE FROM COMPETICIONES WHERE UPPER (NOMBRE)='TORNEO 2'), 1);
INSERT INTO EQUIPO_COMPETICION (COD_EQUIPO, COD_COMPETICION, PUNTOS) 
VALUES ((SELECT COD_EQUIPO FROM EQUIPOS WHERE UPPER(NOMBRE) = 'TEAM GAMMA'), 
(SELECT COD_COMPE FROM COMPETICIONES WHERE UPPER (NOMBRE)='TORNEO 2'), 0);
INSERT INTO EQUIPO_COMPETICION (COD_EQUIPO, COD_COMPETICION, PUNTOS) 
VALUES ((SELECT COD_EQUIPO FROM EQUIPOS WHERE UPPER(NOMBRE) = 'TEAM HIPPIE'), 
(SELECT COD_COMPE FROM COMPETICIONES WHERE UPPER (NOMBRE)='TORNEO 2'), 5);
INSERT INTO EQUIPO_COMPETICION (COD_EQUIPO, COD_COMPETICION, PUNTOS) 
VALUES ((SELECT COD_EQUIPO FROM EQUIPOS WHERE UPPER(NOMBRE) = 'TEAM INDY'), 
(SELECT COD_COMPE FROM COMPETICIONES WHERE UPPER (NOMBRE)='TORNEO 3'), 9);
INSERT INTO EQUIPO_COMPETICION (COD_EQUIPO, COD_COMPETICION, PUNTOS) 
VALUES ((SELECT COD_EQUIPO FROM EQUIPOS WHERE UPPER(NOMBRE) = 'TEAM JACK'), 
(SELECT COD_COMPE FROM COMPETICIONES WHERE UPPER (NOMBRE)='TORNEO 3'), 9);
INSERT INTO EQUIPO_COMPETICION (COD_EQUIPO, COD_COMPETICION, PUNTOS) 
VALUES ((SELECT COD_EQUIPO FROM EQUIPOS WHERE UPPER(NOMBRE) = 'TEAM KRACK'), 
(SELECT COD_COMPE FROM COMPETICIONES WHERE UPPER (NOMBRE)='TORNEO 4'), 0);
INSERT INTO EQUIPO_COMPETICION (COD_EQUIPO, COD_COMPETICION, PUNTOS) 
VALUES ((SELECT COD_EQUIPO FROM EQUIPOS WHERE UPPER(NOMBRE) = 'TEAM LEGO'), 
(SELECT COD_COMPE FROM COMPETICIONES WHERE UPPER (NOMBRE)='TORNEO 4'), 1);
...
INSERT INTO ENFRENTAMIENTOS (FECHA, COD_JORNADA, HORA, RESULTADO, 
                            COD_EQUIPO_LOCAL, COD_EQUIPO_VISITANTE)
VALUES (TO_DATE('15/03/2024', 'dd/MM/yyyy'), 11, '16:00', 
        (SELECT NOMBRE FROM EQUIPOS WHERE COD_EQUIPO = 1), 1, 4);
INSERT INTO ENFRENTAMIENTOS (FECHA, COD_JORNADA, HORA, RESULTADO, 
                            COD_EQUIPO_LOCAL, COD_EQUIPO_VISITANTE)
